...
public class TripleSeqSearchTest {
    ...
    @Test
    public void testFitWithEvenNegative() {
        assertTrue(TripleSeqSearch.hasSequence(new int[]{1, 2, 7, 3, 4, -10, 5, -4, 9}));
    }
    ...
    @Test
    public void testZeroNoNegative() {
        assertFalse(TripleSeqSearch.hasSequence(new int[]{2, 7, 3, 0, 3, 4, 5}));
    }

    @Test
    public void testZeroBeforeNegative() {
        assertFalse(TripleSeqSearch.hasSequence(new int[]{2, 7, 3, 0, 4, -3, 5}));
    }
    @Test
    public void testFitWithZeroBeforeNegative() {
        assertTrue(TripleSeqSearch.hasSequence(new int[]{2, 7, 3, 0, -3, 4, 5}));
    }
